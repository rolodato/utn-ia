...
algoritmos genéticos, transporte de pasajeros, optimización, Scala
}

\mainsection{Introducción}{%

% TODO Considerar trabajos anteriores?

El problema que buscamos resolver es el de optimizar con qué frecuencias deben partir colectivos urbanos para minimizar las siguientes tres variables, que se consideran con el mismo peso a la hora de comparar posibles soluciones:
...
Los algoritmos genéticos permiten encontrar soluciones potencialmente óptimas a problemas complejos de búsqueda y optimización mediante un proceso estocástico que emula el comportamiento de una población de organismos biológicos sujeta a selección natural.
